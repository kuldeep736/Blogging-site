    ...
    <main class="flex items-center justify-center min-h-[600px] bg-green-50">
        <div class="flex w-full max-w-4xl shadow-lg rounded-lg overflow-hidden bg-white">
            ...
            <div class="flex-1 flex flex-col justify-center items-center p-8">
                ...
                <form action="login" class="w-full">
                 <%
                    ...
                    <div class="w-full mb-4">
                        ...
                        <input type="text" id="username" name="t1" placeholder="Username or email" required
                    ...
                    <button type="submit"
                        class="w-full bg-green-600 text-white p-3 rounded transition hover:bg-green-700">Login</button>
                ...
                <p class="mt-4 text-gray-600"> <a href="Forgot.jsp"
                        class="text-gray-600 hover:underline">Forgot password?</a></p>
                <% //String sms=(String)request.getAttribute("sms"); 
                //if (sms !=null) { 
                	//out.print(sms); 
                	//} %>
